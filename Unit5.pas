...
begin
  ...
  if SelectDirectory('Укажите путь к Вашей папке', '\\fas2.mtb.minsk.by\g\All\UEIS', chosenDirectory)
  then ShowMessage('Ваша рабочая директория = '+chosenDirectory)
  else ShowMessage('Папка не выбрана');
