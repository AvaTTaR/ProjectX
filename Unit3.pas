...
begin
  ...
  //копируем папку
  CF.Wnd:=0;
  CF.pFrom:=dndfilename;//откуда копируем файлы для вас будет ваша папка
  CF.pTo:='D:\SD_optima\out';//куда копируем если такого каталога нет то будет предложено его создать
